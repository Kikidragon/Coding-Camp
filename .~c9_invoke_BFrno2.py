    ...
    deif path == "1":
        ...
        if finalstage == "f":
            ...
            if finalchoice == "n":
                ...
                if end == "n":
                    print("Goodbye!")
                print("You arrive in the cave and are teleported home. After arriving in your home, England, you are able to turn into a dragon whenever you want using the magical wand, and get to keep your weapon as well. You know you wil
            if finalchoice == "y":
